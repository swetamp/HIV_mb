...
#UPDATE 5-20-2024: From LM Editor: would like us to add the correlation value for the darkest orange in our legend. We submitted an annotated version of Fig4SparCC_V2 with our revised manuscript, so will re-run the entire SpiecEasi set of code (not copied) and re-do the figure (code copied below) with legend modified. Then we will check it against our Fig4SparCC_V2 as the ONLY difference between the 2 figures should be the legend. 

SparccP_plot2d <- SparccPcsv %>% ggplot(aes(x = Var2, y = Var1, fill = cor)) + geom_tile() +
