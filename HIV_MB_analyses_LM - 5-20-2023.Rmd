...
ggsave("/Users/swetapatel/OneDrive - Duke University/Fogarty coding/Fig2NEW(maaslin).pdf", plot = fig3, dpi = 300, width = 12, height = 4)
```
...
# scale_x_discrete(limits=rev) + scale_y_discrete(position = "right")
...
relative_df$Species <- factor(relative_df$Species)
relative_df$Species <- reorder(relative_df$Species, new.order=c("Corynebacterium propinquum", "Corynebacterium pseudodiphtheriticum", "Dolosigranulum pigrum", "Haemophilus influenzae", "Micrococcus luteus", "Moraxella catarrhalis", "Moraxella lincolnii",  "Moraxella nonliquefaciens", "Staphylococcus aureus", "Streptococcus pneumoniae", "Other"))

subject_plot_cd4 <- ggplot(relative_df[order(relative_df$Species, decreasing = TRUE),], aes(x=cd4cat, y=subject_abundances, fill=Species)) + geom_bar(stat="identity", position="fill") + theme_classic() + theme(legend.position="right", legend.text=element_markdown(), axis.title.y = element_text(size=12, margin=margin(0,20,0,0)), axis.text.y = element_text(size=10), axis.title.x = element_blank(), axis.text.x = element_text(size=10, angle = 45, vjust = 1, hjust = 1, colour = "black")) + scale_fill_manual(values = chisp2, labels = c("*Corynebacterium propinquum*", "*Corynebacterium pseudodiphtheriticum*", "*Dolosigranulum pigrum*", "*Haemophilus influenzae*", "*Micrococcus luteus*", "*Moraxella catarrhalis*", "*Moraxella lincolnii*", "*Moraxella nonliquefaciens*",  "*Staphylococcus aureus*", "*Streptococcus pneumoniae*", "Other")) +
  ylab("Mean relative abundance") 

p4 <- plot(subject_plot_cd4)
...
ggsave("/Users/swetapatel/OneDrive - Duke University/Fogarty coding/fig2NEW.pdf", plot = fig2, dpi = 300, height = 9, width = 11)
...
#abbreviate HIV status
relative_df$hiv2 <- NA
relative_df$hiv2 [relative_df$hiv == "Infected"] <- "Immunocompetent CLWH"
relative_df$hiv2 [relative_df$hiv == "Exposed Uninfected"] <- "HEU children"
relative_df$hiv2 [relative_df$hiv == "Unexposed"] <- "HUU children"
table(relative_df$hiv2)
#matches up with table(relative_df$hiv)
relative_df$hiv2 <- as.factor(relative_df$hiv2)
relative_df$hiv2 <- reorder(relative_df$hiv2, new.order=c("Immunocompetent CLWH", "HEU children", "HUU children"))
relative_df$Species <- factor(relative_df$Species)
relative_df$Species <- reorder(relative_df$Species, new.order=c("Corynebacterium propinquum", "Corynebacterium pseudodiphtheriticum", "Dolosigranulum pigrum", "Haemophilus influenzae", "Micrococcus luteus", "Moraxella catarrhalis", "Moraxella lincolnii", "Moraxella nonliquefaciens", "Staphylococcus aureus", "Streptococcus pneumoniae", "Other"))
spec_eiuu <- ggplot(relative_df[order(relative_df$Species, decreasing = TRUE),], aes(x=hiv2, y=subject_abundances, fill=Species)) +   geom_bar(stat="identity", position="fill") + theme_classic() + theme(
  legend.position="right", legend.text=element_markdown(), axis.title.y = element_text(size=12, margin=margin(0,20,0,0)), axis.text.y = element_text(size=10), axis.title.x = element_blank(), axis.text.x = element_text(size=10, angle = 45, vjust = 1, hjust = 1, colour = "black")) +  
  scale_fill_manual(values = chisp2, labels = c("*Corynebacterium propinquum*", "*Corynebacterium pseudodiphtheriticum*", "*Dolosigranulum pigrum*", "*Haemophilus influenzae*", "*Micrococcus luteus*", "*Moraxella catarrhalis*", "*Moraxella lincolnii*", "*Moraxella nonliquefaciens*",  "*Staphylococcus aureus*", "*Streptococcus pneumoniae*", "Other")) +
  ylab("Mean relative abundance") 
...
#CREATE MELTED_DF FOR RELATIVE ABUNDANCE PLOTS
...
melted_df <- within(melted_df, rm(sib_weight, sib_sex, sib_height, sib_muac, sib_race, sib_bfeed_1,
                                  sib_bfeed_2, sib_uri_recent, sib_uri_current, sib_pcr_1, sib_pcr_2,
                                  sib_bcg, sib_hepb, sib_clinic, sib_clinic_dx___5, sib_clinic_dx_oth,
                                  sib_hosp, sib_meds, sib_meds_name, sibmo, sibyr, sib_vl1_weeks, sib_vl_weeks2, sib_med_days, sib_dpt, sib_pcv, sib_rota, sib_polio, sib_measles, sib_age))
melted_df <- within(melted_df, rm(samp_storage, enr_clinic, enr_clinic_other, mat_np))
...
relative_df$Species[!(relative_df$Species %in% TOPSpecies)] <- "Other"
sum(relative_df$Abundance) #sums to 110.0008 (and we have n=110 kids...?)
table(relative_df$Species)

#already generated our chisp2 color palette

#CREATING RELATIVE ABUNDANCE PLOT
relative_df$subject_abundances <- (relative_df$Abundance)/(length(unique(relative_df$Sample))) 
#abbreviate HIV status
relative_df$hiv2 <- NA
relative_df$hiv2 [relative_df$hiv == "Infected"] <- "Immunocompromised CLWH"
relative_df$hiv2 [relative_df$hiv == "Exposed Uninfected"] <- "HEU children"
relative_df$hiv2 [relative_df$hiv == "Unexposed"] <- "HUU children"
table(relative_df$hiv2)
#matches up with table(relative_df$hiv)
relative_df$hiv2 <- as.factor(relative_df$hiv2)
relative_df$hiv2 <- reorder(relative_df$hiv2, new.order=c("Immunocompromised CLWH", "HEU children", "HUU children"))

relative_df$Species <- factor(relative_df$Species)
relative_df$Species <- reorder(relative_df$Species, new.order=c("Corynebacterium accolens", "Corynebacterium propinquum", "Corynebacterium pseudodiphtheriticum", "Dolosigranulum pigrum", "Haemophilus influenzae",  "Moraxella catarrhalis", "Moraxella lincolnii", "Moraxella nonliquefaciens", "Staphylococcus aureus", "Streptococcus pneumoniae", "Other"))

spec_hlow <- ggplot(relative_df[order(relative_df$Species, decreasing = TRUE),], aes(x=hiv2, y=subject_abundances, fill=Species)) + 
  geom_bar(stat="identity", position="fill") + theme_classic() + theme(
  legend.position="right", legend.text=element_markdown(), axis.title.y = element_text(size=12, margin=margin(0,20,0,0)), axis.text.y = element_text(size=10), axis.title.x = element_blank(), axis.text.x = element_text(size=10, angle = 45, vjust = 1, hjust = 1, colour = "black")) +  
  scale_fill_manual(values = chisp2, labels = c("*Corynebacterium accolens*","*Corynebacterium propinquum*", "*Corynebacterium pseudodiphtheriticum*", "*Dolosigranulum pigrum*", "*Haemophilus influenzae*", "*Moraxella catarrhalis*", "*Moraxella lincolnii*", "*Moraxella nonliquefaciens*",  "*Staphylococcus aureus*", "*Streptococcus pneumoniae*", "Other")) +
  ylab("Mean relative abundance") 

hlow_plot <- plot(spec_hlow)
...
fig_HEU_HUU_CD4hilow <- plot_grid(clr_hlow, hlow_plot, clr_eiuu, spec_eiuu,labels = "AUTO", nrow = 2, ncol = 2, align = "h", axis = "b", rel_widths = c(1,1.3))

ggsave("/Users/swetapatel/OneDrive - Duke University/Fogarty coding/Fig S_CD4hilow_HEU_HUU.pdf", plot = fig_HEU_HUU_CD4hilow, dpi = 300, width = 11, height = 9)

png(file="/Users/swetapatel/OneDrive - Duke University/Fogarty coding/Fig S_CD4hilow_HEU_HUU.png",
...
- We see a strong association between HIV status and any history of breastfeeding in our cohort. Given the established association between breastfeeding and NP microbiome composition, what do our results look like if we compare NP microbiome characteristics among children who were exclusively breastfed?
...
#Create pseq object of only exclusively breastfed children
chi_bf = subset_samples(chi_prune, bfeed_1 == 1) #should have 49 kids and it does
...
#No association between hIV status and alpha diversity measures among exclusively breastfed children
```
...
#Significant difference by HIV status among exclusively breastfed children (P = 0.007, R2 = 0.074) but not age (P=0.33, R2 = 0.021)
...
#need to remove the unidentified species from here (n=4): row 8, 19, 35, 36
  #source: https://stackoverflow.com/questions/12328056/how-do-i-delete-rows-in-a-data-frame
...
fit_data2 = Maaslin2(
  ...
  min_prevalence = 0.2,
  max_significance = 0.2,
  output = "/Users/swetapatel/OneDrive - Duke University/Fogarty coding/Sequencing/maaslin_mv_filt50_bf", 
  fixed_effects = c("hiv2", "season", "age", "abx", "wood", "uri_rec2"),
  reference = c("hiv2,HUU children"))

#CLWH have significantly less C. pseudodiphtheriticum!
```

#### Relative abundance plots

```{r}
chi.rel <- transform_sample_counts(chi_bf, function(Abundance) Abundance/sum(Abundance))
sample_sums(chi.rel)  # This is a sanity check to make sure that relative abundance was calculated for each sample prior to pooling data
#All samples add to 1
melted_df <- psmelt(chi.rel)
#clean up melted_df
...
relative_df$Species[!(relative_df$Species %in% TOPSpecies)] <- "Other"
sum(relative_df$Abundance) #sums to 49.00032 (and we have n=49 kids...?)
table(relative_df$Species)
...
relative_df$Species <- reorder(relative_df$Species, new.order=c("Corynebacterium propinquum", "Corynebacterium pseudodiphtheriticum", "Dolosigranulum pigrum", "Haemophilus haemolyticus", "Haemophilus influenzae", "Micrococcus luteus", "Moraxella catarrhalis", "Moraxella lacunata", "Moraxella nonliquefaciens", "Streptococcus pneumoniae", "Other"))

spec_bf <- ggplot(relative_df[order(relative_df$Species, decreasing = TRUE),], aes(x=hiv2, y=subject_abundances, fill=Species)) +   geom_bar(stat="identity", position="fill") + theme_classic() + theme(
  legend.position="right", legend.text=element_markdown(), axis.title.y = element_text(size=12, margin=margin(0,20,0,0)), axis.text.y = element_text(size=10), axis.title.x = element_blank(), axis.text.x = element_text(size=10, angle = 45, vjust = 1, hjust = 1, colour = "black")) +  
  scale_fill_manual(values = chisp2, labels = c("*Corynebacterium propinquum*", "*Corynebacterium pseudodiphtheriticum*", "*Dolosigranulum pigrum*", "*Haemophilus haemolyticus*", "*Haemophilus influenzae*", "*Micrococcus luteus*", "*Moraxella catarrhalis*", "*Moraxella lacunata*", "*Moraxella nonliquefaciens*", "*Streptococcus pneumoniae*", "Other")) +
  ylab("Mean relative abundance") 

bf_plot <- plot(spec_bf)

#Create supplemental sensitivity analysis figure
fig_bf <- plot_grid(p_bf, bf_plot, labels = c('A', 'B'), align = "h", axis = "b", label_size = 12, rel_widths = c(1, 1.5))
fig_bf

ggsave("/Users/swetapatel/OneDrive - Duke University/Fogarty coding/Fig_bf.pdf", plot = fig_bf, dpi = 300, width = 11, height = 4)

png(file="/Users/swetapatel/OneDrive - Duke University/Fogarty coding/Fig S_bf.png",
